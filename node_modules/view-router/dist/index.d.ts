...
export declare type ContextFunction<T extends {}> = (req: express.Request, res: express.Response) => Promise<T> | T;
/**
 ...
 */
export declare function viewRouter(options?: IViewRouterOptions): (req: express.Request, res: express.Response, next: express.NextFunction) => void;
/**
 * A middle-ware function for express to handle routing of views through a
 * template engine
 *
 ...
 * @returns {(req: express.Request, res: express.Response, next: express.NextFunction) => void}
 */
export declare function viewRouter(views: IViewConfig[], options?: IViewRouterOptions): (req: express.Request, res: express.Response, next: express.NextFunction) => void;
